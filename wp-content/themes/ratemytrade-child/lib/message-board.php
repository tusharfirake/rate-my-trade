...
?>
	...
	<div style="color:#000;" class="box_title"><?php echo sprintf(__("Public Message Board: %s",'ProjectTheme'), $post_au->post_title ); ?></div>
    ...
    ?>
                ...
                <div class="padd10">
                <form method="post" id="info_form" action="<?php echo get_permalink($pid); ?>" style="color:#000;"> 
