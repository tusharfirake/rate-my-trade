...
<div id="main_wrapper">
	<div id="bg">
		<div id="main" class="container">
 			<div id="login_my_box" class="my_box3">
            	<div class="padd10">
 	                <div class="box_content">
                        <div class="login-submit-form"> 
							<form name="lostpass" action="<?php echo esc_url( site_url( 'wp-login.php?action=lostpassword', 'login_post' ) ); ?>" method="post" id="loginform" class="lostpswrd">
								<p class="lostpass_p" ><?php _e('Please enter your information here. We will send you a new password.',$current_theme_locale_name); ?></p>
			                 	...
			                 	<?php do_action('lostpassword_form'); ?>
                  				<div class="row">
                  					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<p class="lostpass_btn_submit">
											<label>&nbsp;</label>
											<input type="submit" name="submit" id="post_free_job_btn" value="<?php _e('Retrieve Password',$current_theme_locale_name); ?>"  class="submit_bottom" tabindex="3" />
		                                </p>
	                				</div>
	                				<div id="forgot_pswd_form_btns" class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				                		<p id="abc" class="lostpass_btn_login">
				                			<a id="post_free_job_btn" class="btn" href="<?php bloginfo('wpurl'); ?>/wp-login.php"><?php _e('Login',$current_theme_locale_name) ?></a>
				                		</p>
						           	</div>
                				</div>
                			</form>
		...
		<?php
			...
			case 'retrievepassword2': 
		        ...
		        <div id= "login_error_my_box" class="my_box3">
		          	<div class="padd10">
			  ...
			  do_action('retrieve_password', $user_login);
				...
				$message .= sprintf(__('Username or Email: %s',$current_theme_locale_name), $user_login) . "\r\n\r\n";
			...
			case 'rp' :
				...
				if ( !$user )
			  {
				...
				$message  = sprintf(__('Username or Email: %s',$current_theme_locale_name), $user->user_login) . "\r\n";
...
<div id="main_wrapper">
	<div id="bg">
		<div id="main" class="container">
        	<div id="login_check_mail_my_box" class="my_box3">
            	<div  class="padd10 row">
                	<div class="box_content col-xs-12 col-sm-7 col-md-7 col-lg-7">
	                	...
	                	<div id="login_submit_form" class="login-submit-form"> 
	                   		<form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
								<h4>Login Here</h4>
								<hr>
								<p>
									<label>
										<?php _e('Username or Email:',$current_theme_locale_name) ?>
									</label>
								...
								<p>
									<label>
										<?php _e('Password:',$current_theme_locale_name); ?>
									</label>
								...
								<p>
									...
									<input class="" name="rememberme" type="checkbox" id="rememberme" value="true" tabindex="3" /> 
										<?php _e('Remember Me?',$current_theme_locale_name); ?>
			                	</p>
										
										 
			                	<?php do_action('login_form'); ?>
			                    <div id="button_n_links">        
				                    <div id="login_button_div" class="col-xs-4 col-sm-4 col-md-4 col-lg-4 ">         
										<p>
											<!-- <label>&nbsp;</label> -->
											<input type="submit" class="submit_bottom" name="submits" id="post_free_job_btn" value="<?php _e('LOGIN',$current_theme_locale_name); ?>" tabindex="4" />
											<input type="hidden" name="redirect_to" value="<?php echo wp_specialchars($redirect_to); ?>" />
										</p>
									</div>
									<div id="forgot_pswd_div" class="col-xs-8 col-sm-8 col-md-8 col-lg-8"> 
										<!-- <p><a class="green_btn" href="<?php bloginfo('home'); ?>/" 
					                            title="<?php _e('Are you lost?',$current_theme_locale_name) ?>">&laquo; <?php _e('Home',$current_theme_locale_name) ?></a></p> -->
											  										  <?php if (get_settings('users_can_register')) : ?>
												<!-- <p><a class="submit_bottom" href="<?php bloginfo('wpurl'); ?>/wp-login.php?action=register"><?php _e('Register',$current_theme_locale_name) ?></a></p> -->
											  <?php endif; ?>
												<p id="lost-password"><a id="forgot_pswd_link" class="" href="<?php bloginfo('wpurl'); ?>/wp-login.php?action=lostpassword" 
					                            title="<?php _e('Password Lost and Found',$current_theme_locale_name) ?>"><?php _e('Lost your password?',$current_theme_locale_name) ?></a></p>
				              		</div>
			              		</div>
						...
						</div> <!-- login-submit-form colse -->

						<div>
		        			<div id="social_login_links">
		        				<div id="social_login_div" class="row">
		        			...
		        			</div> <!-- social_login_links end -->
	    				</div>
	    			</div> <!-- box-content colse -->
				    <div id="join_us_div" class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
				    	<div id="join_us_inner_div">
				        	<h4>Join Us,<span> It's Free!</span></h4>
				        	<hr>
				        	<p class="join_us_big_font">Looking for a builder or tradesman?</p>
				        	<p class="join_us_small_font">Post your job here and get quick responses, reputable tradespeople.</p>
				        	<p class="join_us_big_font"><a  class="post-btn" href="<?php echo projectTheme_post_new_link(); ?>">Post a job</a></p>
				        	<br>
				        	<p class="join_us_big_font"><a href="<?php echo site_url().'/tradesman-start/'?>" id="post_free_job_btn" > Sign up as tradesman</a></p>
				        	<p class="join_us_small_font">We help tradesmen get the right kind of work, in the most affordable way.</p>
				        	
		      			</div>
		      		</div> <!-- join-us-div colse -->
	      		</div> <!-- padd10 colse -->
