...
?>
   ...
   ?>
        ...
        <li>
        <h2>&nbsp;</h2>
        <p><input id="post_free_job_btn" type="submit" name="save-info" class="my-buttons" value="<?php _e("Save" ,'ProjectTheme'); ?>" /></p>
        </li>
    ...
    <div class="dropzone dropzone-previews" id="myDropzoneElement2" ></div>
		...
		?>
                    ...
                    <li>
                        ...
                        <p><div style="border:1px solid #ccc; overflow:auto; width:350px; border-radius:5px; height:160px;">
        ...
        <p><input id="post_free_job_btn" type="submit" class="my-buttons" name="save-info" value="<?php _e("Save" ,'ProjectTheme'); ?>" /></p>
        </li>
