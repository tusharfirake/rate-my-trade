...
<div id="content" class="sonita">
    <div class="my_box3">            
        <div id="post_new_box_content" class="box_content"> 
            <?php
				$is_it_allowed = true;
...
//****************************************************************************************
			...
			if($new_Project_step == "1")
			{
				...
				?>
    			<div id="post_new_page_data" class="sonita2">
 					<form method="post" action="<?php echo ProjectTheme_post_new_with_pid_stuff_thg($pid, '1');?>">  
    					...
    					<?php do_action('ProjectTheme_step1_before_title'); ?>
					        ...
					        <?php echo projecttheme_get_post_new_error_thing_display('project_title') ?>
					        	...
					        	<p>
					        		<input type="text" size="50" class="do_input_new full_wdth_me" name="project_title" placeholder="<?php _e('eg: I need a website created very soon.','ProjectTheme') ?>" value="<?php echo (empty($_POST['project_title']) ? 
									($post->post_title == "Auto Draft" ? "" : $post->post_title) : $_POST['project_title']); ?>" />
								</p>
					        </li>
					        ...
					        <li class="<?php echo projecttheme_get_post_new_error_thing('project_description') ?>">
						        ...
						        <p>
						        	<textarea rows="6" cols="60" class="full_wdth_me do_input_new description_edit" placeholder="<?php _e('Describe here your project scope.','ProjectTheme') ?>"  name="project_description"><?php echo trim($pst); ?></textarea>
						        </p>
					        </li>
							...
							<li>
					        	...
					        	<p>
					        		<input type="text" size="50" class="full_wdth_me do_input_new"  name="project_tags" placeholder="<?php _e('eg: something, comma, separated.','ProjectTheme') ?>" value="<?php echo $project_tags; ?>" /> 
					        	</p>
					        </li>
        				    ...
        				    <li>
							    ...
							    ?>
       							<p>
       								<input type="text" name="ending" id="ending" class="full_wdth_me do_input_new" value="<?php echo $dt; ?>"  />
       							</p>
       						</li>
        					...
        					<li  class="<?php echo projecttheme_get_post_new_error_thing('project_location') ?>">
        			        	...
        			        	<h2>
        			        		<?php echo __('Location', 'ProjectTheme'); ?>
        			        	</h2>
        						<p class="strom_100"> 
	   ...
	   ?> 
		...
		if($ProjectTheme_enable_images_in_projects != "no"):
...
myDropzone.on("removedfile", function(file, response) {
	...
	function delete_this2(id)
	{
        ...
        <h2>&nbsp;</h2>
        <p> 
        <input type="submit" id="post_free_job_btn" name="project_submit1" value="<?php _e("Next Step", 'ProjectTheme'); ?> >>" class="submit_bottom" /></p>
        </li>
	...
	?>
 	...
 	<ul class="post-new">
      ...
      <?php do_action('ProjectTheme_step2_before_project_files'); ?>
        ...
        <input type="submit" id="post_free_job_btn" name="project_submit2" value="<?php _e("Next Step", 'ProjectTheme'); ?> >>" class="submit_bottom" /></p>
        </li>
...
<div class="my_box3">
        ...
        <li>
        <h2>&nbsp;</h2>
        <p><input type="submit" id="post_free_job_btn" name="report_this" value="<?php _e('Submit Report','ProjectTheme'); ?>" /></p>
        </li>
...
if($new_Project_step == "4")
{
	...
	if($total == 0)
	{
			echo '<div id="post_new_thank_you_div" >';
	...
	echo '<div id="finalize_step" class="padd10">';
	if($finalize == false)
