...
?>
	<div id="content" class="adv_search_content" >
...
<div id="right-sidebar" class="adv_search_right-sidebar">
	<li class="">
    	<h3 id="adv_search_sidebar_title" class="widget-title">
        ...
        <form method="get">
            <table>
                <tr>
                   	<td class="adv_search_sidebar_lable" >
                   		<?php _e('Keyword',"ProjectTheme"); ?>:
                   	</td>
                   	<td>
                   		<input size="20" class="" value="<?php echo $_GET['term']; ?>" name="term" />
                   	</td>
                </tr>
                   
                <tr>
                   	<td class="adv_search_sidebar_lable" >
                   		<?php _e('Price',"ProjectTheme"); ?>:
                   	</td>
                   	<td>
                   		<?php echo ProjecTheme_get_budgets_dropdown($_GET['budgets'], 'budgets_advanced_search', 1); ?>
                   	</td>
                </tr>
                   
                <tr>
                   	<td class="adv_search_sidebar_lable" >
                   		<?php _e('Location',"ProjectTheme"); ?>:
                   	</td>
                  	<td>
                  		<?php	echo ProjectTheme_get_categories_slug("project_location", $_GET['project_location_cat'],__("Select Location","ProjectTheme"), 'categ_advanced_search'); ?>
                  	</td>
                </tr>
                   
                <tr>
                   	<td class="adv_search_sidebar_lable" >
                   		<?php _e('Category',"ProjectTheme"); ?>:
                   	</td>
                   	<td>
                   		<?php	echo ProjectTheme_get_categories_slug("project_cat", $_GET['project_cat_cat'],__("Select Category","ProjectTheme") , 'categ_advanced_search'); ?>
                   	</td>
                </tr>
                ...
                <tr>
                   	<td class="adv_search_sidebar_lable" >
                   		<?php _e('Featured?',"ProjectTheme"); ?>:
                   	</td>
                   	<td id="adv_search_sidebar_checkbox">
                   		<input type="checkbox" name="featured" value="1" <?php if(isset($_GET['featured'])) echo 'checked="checked"'; ?> />
                   	</td>
                </tr>
                ...
                <tr>
                   	...
                   	<td>
                   		<input type="submit" value="<?php _e("Refine Search","ProjectTheme"); ?>" name="ref-search" id="adv_search_sidebar_submit" class="big-search-submit2" />
                   	</td>
                </tr>
            </table>
        </form> 
