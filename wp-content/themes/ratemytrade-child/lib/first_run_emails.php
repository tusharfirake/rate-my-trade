<?php
	...
	// $mail_contents='<html>
	// 					<head>
	// 						<img src="http://ratemytrade.brandsout.com/wp-content/uploads/2015/03/logo1-300x75.png">
	// 					</head>
	// 					<body>
	// 						<h3>Welcome ##username##</h3><br>
	// 						<p>Your username: <b>##username##</b></p><br>
	// 						<p>Your password: <b>##user_password##</b></p><br>
	// 						<p>Login here: <b>##site_login_url##</b></p><br>
	// 						<p>Thank you,</p><br>
	// 						<p><b>##your_site_name##</b> Team</p><br>
	...
	if(empty($opt)):
		...
		update_option('ProjectTheme_new_user_email_message', 'Hello ##username##,'.PHP_EOL.PHP_EOL.
			...
			//update_option('ProjectTheme_new_user_email_message', $mail_contents);
		//-----------------------------------------------------------------------------------------------------------
