...
<form method="get" action="<?php echo $lnk ?>">
<div id="category_filter_field_area" class="filter-field-area">
	<div class="padd10">
		<div class="row">
        	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
				<div class="category_lable"><?php echo __('Keyword:','ProjectTheme') ?> </div>
				<div  id="category_input_keyword" ><input type="text" placeholder="<?php _e('Type here...','ProjectTheme') ?>" value="<?php echo stripslashes($_GET['keyword']) ?>" name="keyword" size="30" class="do_input" /> </div>			
			</div>
            
            
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
				<div class="category_lable"><?php echo __('Project Budget:','ProjectTheme') ?> </div>
				<div id="category_input"><?php echo ProjecTheme_get_budgets_dropdown($_GET['budgets'], 'do_input' , 1); ?> </div>			
			</div>
            
            
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
				<div class="category_lable"><?php echo __('Ending In:','ProjectTheme') ?> </div>
				<div id="category_input"><select name="ending" class="do_input">
                <option value=""><?php _e('Select Period','ProjectTheme') ?></option>
                <option value="1" <?php echo ($_GET['ending'] == 1 ? 'selected="selected"' : '') ?>><?php _e('1 day','ProjectTheme') ?></option>
                <option value="7" <?php echo ($_GET['ending'] == 7 ? 'selected="selected"' : '') ?>><?php _e('7 days','ProjectTheme') ?></option>
                <option value="30" <?php echo ($_GET['ending'] == 30 ? 'selected="selected"' : '') ?>><?php _e('30 days','ProjectTheme') ?></option>
        ...
        <div class="row">   
             <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
             	<div class=""></div>
				<div class=""><input type="submit" name="apply_filters" class="submit_bottom2" value="<?php _e('Apply Filters','ProjectTheme') ?>" /></div>
			</div>
        </div>
...
<div id="content" class="category_search_result">
