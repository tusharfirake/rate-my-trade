...
***************************************************************************/
 	...
 	include(get_stylesheet_directory().'/custom-function.php');
	load_theme_textdomain( 'ProjectTheme',  TEMPLATEPATH . '/languages' );
	// load the theme template for translation
	
	DEFINE("PROJECTTHEME_VERSION", "2.0.8");
	DEFINE("PROJECTTHEME_RELEASE", "12 March 2015");
...
function ProjectTheme_create_post_type() {
	...
	register_taxonomy( 'project_cat', 'project', array( 'rewrite' => array('slug'=>'classification','with_front'=>false) ,
		'hierarchical' => true,   'label' => __('Project Categories','ProjectTheme') ) );
	register_taxonomy(   'project_location', 'project', array('rewrite' => array('slug'=>$location_url_link,'with_front'=>false),
	 ...
	 register_taxonomy( 'project_skill', 'project', array( 'rewrite' => array('slug'=>'skill','with_front'=>false) ,'hierarchical' => true,   'label' => __('Skills','ProjectTheme') ) );
...
{
	$full 	= get_bloginfo('template_url')."/images/full_star.png";
	$empty 	= get_bloginfo('template_url')."/images/empty_star.png";	
